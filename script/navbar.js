...
navToggle.addEventListener("click", () => {
    ...
    navMenu.classList.toggle('nav_menu_link_visible');
    ...
    if(navMenu.classList.contains('nav_menu_link_visible')) {
...
menuLogin.addEventListener('click', (e)=> {
    ...
    if(!optionLogin.classList.contains('nav_menu_link_inside')) {
