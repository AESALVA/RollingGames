...
const DATA_GAMES = [
	...
	},
	{
	  ...
	  img_historia:
		"/RollingGames/AssetData/hearthstone/bg_historia/A12Uzob0MJL.jpg",
	  img_muestra: [
	  ...
	  imagenes: [
		...
		"/RollingGames/AssetData/hearthstone/trailer/maxresdefault (1).jpg",
		"/RollingGames/AssetData/hearthstone/trailer/maxresdefault.jpg",
	  ],
	  animation: [
		"/RollingGames/AssetData/hearthstone/trailer/img1_juego.gif",
...
data.map((d)=>{
	...
	remarkable.innerHTML = ` <div id="card-destacado" class="card mb-0">
				<div class="row g-0">
				  <div class="col-md-8">
					<img src="${d.img}" id="img-destacado" class="img-fluid" alt="SPIDERMAN">
				  </div>
				  <div class="col-md-4">
					<div class="card-body">
					  <h5 class="card-title">SPIDER-MAN REMASTERED</h5>
					  <p class="card-text text-muted">YA DISPONIBLE</p>
					  <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium deserunt omnis laboriosam delectus praesentium nihil, quasi, animi odio quo pariatur qui, blanditiis molestias quisquam aut labore! Magnam quis exercitationem asperiores.</p>
					  <a id="ver-mas-btn" class="btn btn-primary btn-sm " href="/RollingGames/detalleJuego.html" target:"_parent" role="button">Ver más</a>
					</div>
				  </div>
				</div>
			</div>`;
...
createRemarkable(DATA_REMARKABLE);
